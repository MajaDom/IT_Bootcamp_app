...
def create_attendance(attendance: AttendanceSchemaIn):
    return AttendanceController.create_attendance(attendance.status, attendance.description, attendance.user_generation_id, attendance.lessons_id) 
...
@attendance_router.patch("/update-attendance", response_model = AttendanceSchema) 
