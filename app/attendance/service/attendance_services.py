    ...
    def create_attendance(description, status, user_generation_id, lessons_id):
        with SessionLocal() as db:
            try:
                ...
                fields = {"description": description, "status": status, "user_generation_id": user_generation_id, "lessons_id": lessons_id}
        ...
        try:
            with SessionLocal() as db:
                ...
                updated_attendance = stored_attendance_model.copy(
                    update=update_data)
                return attendance_repository.update_attendance_by_id(attendance_id, updated_attendance.description, updated_attendance.status, updated_attendance.user_generation_id, updated_attendance.lessons_id)
        except Exception as e:
            raise e
