"""Homework Repository module"""
from sqlalchemy.exc import IntegrityError
from app.base import BaseCRUDRepository, AppException


class HomeworkRepository(BaseCRUDRepository):
    """Repository for Homework Model"""
    def create(self, attributes: dict):
        """
        The create function creates a new homework in the database.
        It takes an attributes dictionary as its only parameter, and returns the created Homework object.
